...
%% Caution: Under special circumstance, if you want to include 2 external guides (supervisor and manager), ensure that your Title of the report is not longer.
...
\projectCoOrdNameA{Dr.Veena Devi}
...
\projectCoOrdNameB{Prof. R Sindhu Rajendran}
